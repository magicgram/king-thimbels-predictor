...
const PostbackUrlComponent: React.FC<{
  ...
  return (
    <div className="p-4 bg-[#0b2545] rounded-lg border border-[#1e293b]">
    ...
    return (
        <div className="w-full h-full flex flex-col text-white font-poppins">
            <header className="flex items-center mb-4 flex-shrink-0 text-[#001e3c]">
                ...
                <h1 className="text-lg md:text-xl font-russo tracking-wide text-center flex-grow uppercase">{t('postbackGuideTitle')}</h1>
            ...
            <div className="flex-grow overflow-y-auto px-1 space-y-6">
                ...
                {domain && (
                    <div className="p-2 text-center bg-[#0b2545] border-b-4 border-[#06162d] rounded-lg text-xs text-yellow-300 shadow-lg">
                        {t('postbackGuideImportant')}: <strong className="font-mono text-white">{domain}</strong>
                    </div>
                )}
